...
#       post opinions_url, params: { opinion: { belongs_to: @opinion.belongs_to, body: @opinion.body } }
#     end
#
...
#     patch opinion_url(@opinion), params: { opinion: { belongs_to: @opinion.belongs_to, body: @opinion.body } }
